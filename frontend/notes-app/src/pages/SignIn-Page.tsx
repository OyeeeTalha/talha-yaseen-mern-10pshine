        ...
        <div className=" dark:bg-card-dark rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:shadow-[0_8px_30px_rgb(0,0,0,0.3)] border border-slate-200 dark:border-slate-800 p-8 sm:p-10 transition-all duration-300">
          ...
          <div className="space-y-4">
            ...
            <div className="relative">
              <Button 
                disabled
                className="group relative flex w-full items-center justify-center gap-3 rounded-lg bg-[#24292e] text-white p-3.5 transition-all opacity-50 cursor-not-allowed"
              >
                <svg
              ...
              <p className="text-center text-xs text-slate-400 dark:text-slate-500 mt-2 font-medium">
                This login feature will be available soon
              </p>
            </div>
          </div>
